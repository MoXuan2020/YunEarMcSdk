...
class Entity(object):
    ...
    def __init__(self, event, entityId):
        self.event = event
    ...
    def CreateEngineType(self):
        return self.GetEngineCompFactory().CreateEngineType(self.entityId)

    def CreateEntityDefinitions(self):
        return self.GetEngineCompFactory().CreateEntityDefinitions(self.entityId)

    def CreateAuxValue(self):
        return self.GetEngineCompFactory().CreateAuxValue(self.entityId)

    def CreateDimension(self):
        return self.GetEngineCompFactory().CreateDimension(self.entityId)

    def CreateEntityComponent(self):
        return self.GetEngineCompFactory().CreateEntityComponent(self.entityId)

    def CreateAttr(self):
        return self.GetEngineCompFactory().CreateAttr(self.entityId)

    def CreateRot(self):
        return self.GetEngineCompFactory().CreateRot(self.entityId)

    def CreateBreath(self):
        return self.GetEngineCompFactory().CreateBreath(self.entityId)

    def CreateGame(self):
        return self.GetEngineCompFactory().CreateGame(self.GetSystemApi().GetLevelId())

    def CreateActorOwner(self):
        return self.GetEngineCompFactory().CreateActorOwner(self.entityId)

    def CreatePos(self):
        return self.GetEngineCompFactory().CreatePos(self.entityId)

    def CreateGravity(self):
        return self.GetEngineCompFactory().CreateGravity(self.entityId)

    def CreateName(self):
        return self.GetEngineCompFactory().CreateName(self.entityId)

    def CreateCollisionBox(self):
        return self.GetEngineCompFactory().CreateCollisionBox(self.entityId)

    def CreateEntityEvent(self):
        return self.GetEngineCompFactory().CreateEntityEvent(self.entityId)

    def CreateActorMotion(self):
        return self.GetEngineCompFactory().CreateActorMotion(self.entityId)

    def CreateRide(self):
        return self.GetEngineCompFactory().CreateRide(self.entityId)

    def CreateAction(self):
        return self.GetEngineCompFactory().CreateAction(self.entityId)

    def CreateControlAi(self):
        return self.GetEngineCompFactory().CreateControlAi(self.entityId)

    def CreateTame(self):
        return self.GetEngineCompFactory().CreateTame(self.entityId)

    def CreateHurt(self):
        return self.GetEngineCompFactory().CreateHurt(self.entityId)

    def CreateActorCollidable(self):
        return self.GetEngineCompFactory().CreateActorCollidable(self.entityId)

    def CreateActorPushable(self):
        return self.GetEngineCompFactory().CreateActorPushable(self.entityId)

    def CreateInteract(self):
        return self.GetEngineCompFactory().CreateInteract(self.entityId)

    def CreateShareables(self):
        return self.GetEngineCompFactory().CreateShareables(self.entityId)

    def CreateMoveTo(self):
        return self.GetEngineCompFactory().CreateMoveTo(self.entityId)

    def CreatePersistence(self):
        return self.GetEngineCompFactory().CreatePersistence(self.entityId)

    def CreateEffect(self):
        return self.GetEngineCompFactory().CreateEffect(self.entityId)

    def CreateActorRender(self):
        return self.GetEngineCompFactory().CreateActorRender(self.entityId)

    def CreateModel(self):
        return self.GetEngineCompFactory().CreateModel(self.entityId)

    def CreateHealth(self):
        return self.GetEngineCompFactory().CreateHealth(self.entityId)

    def CreateItem(self):
        return self.GetEngineCompFactory().CreateItem(self.entityId)

    def CreateModAttr(self):
        return self.GetEngineCompFactory().CreateModAttr(self.entityId)

    def CreateExtraData(self):
        return self.GetEngineCompFactory().CreateExtraData(self.entityId)

    def CreateQueryVariable(self):
        return self.GetEngineCompFactory().CreateQueryVariable(self.entityId)

    def CreateBulletAttributes(self):
        return self.GetEngineCompFactory().CreateBulletAttributes(self.entityId)

    def CreateExp(self):
        return self.GetEngineCompFactory().CreateExp(self.entityId)

    def CreatePet(self):
        return self.GetEngineCompFactory().CreatePet(self.GetSystemApi().GetLevelId())

    def CreateTag(self):
        return self.GetEngineCompFactory().CreateTag(self.entityId)

    def CreateChatExtension(self):
        return self.GetEngineCompFactory().CreateChatExtension(self.entityId)
    ...
    def GetAttrMaxValue(self, attrType):
        return self.CreateAttr().GetAttrMaxValue(attrType)
    ...
    def SetAttrMaxValue(self, attrType, value):
        return self.CreateAttr().SetAttrMaxValue(attrType, value)
    ...
    def AddCommonPhrases(self, chatId, content):
        return self.CreateChatExtension().AddCommonPhrases(chatId, content)
    ...
    def RemoveCommonPhrases(self, chatId):
        return self.CreateChatExtension().RemoveCommonPhrases(chatId)
