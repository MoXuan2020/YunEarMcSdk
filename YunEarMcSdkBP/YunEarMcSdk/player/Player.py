...
class Player(Entity):
    ...
    def CreateLv(self):
        return self.GetEngineCompFactory().CreateLv(self.entityId)

    def CreatePlayer(self):
        return self.GetEngineCompFactory().CreatePlayer(self.entityId)

    def CreateFly(self):
        return self.GetEngineCompFactory().CreateFly(self.entityId)

    def CreateBlockInfo(self):
        return self.GetEngineCompFactory().CreateBlockInfo(self.entityId)

    def CreateCamera(self):
        return self.GetEngineCompFactory().CreateCamera(self.GetSystemApi().GetLevelId())

    def CreatePlayerView(self):
        return self.GetEngineCompFactory().CreatePlayerView(self.entityId)

    def CreatePlayerAnim(self):
        return self.GetEngineCompFactory().CreatePlayerAnim(self.entityId)
    ...
    def GetPlayerExp(self, isPercent=True, playerId=None):
    ...
    def GetPlayerExhaustionRatioByType(self, playerExhauseRatioType):
        return self.CreatePlayer().GetPlayerExhaustionRatioByType(playerExhauseRatioType)
    ...
    def SetPlayerExhaustionRatioByType(self, playerExhauseRatioType, value):
        return self.CreatePlayer().SetPlayerExhaustionRatioByType(playerExhauseRatioType, value)
    ...
    def LockPerspective(self, enable):
        return self.CreateCamera().LockPerspective(enable)
